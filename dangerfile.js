...
if (YarnManifest.modified && !lockfileYarnpkg.modified) {
  warn("We found changes to the package manifest files for Node.js, but the Yarn lockfile isn't updated. Did you just updated the scripts?")
}
